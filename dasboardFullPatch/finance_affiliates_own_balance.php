...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" type='text/css' href="https://cdn.admin.siempregana.net/css/finance_affiliates_own_balance-min.css">
...
<nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-5 col-md-4 mx-auto py-sm-2 mt-2 mb-1 mb-sm-4">
                        <div class="card transparent text-center z-depth-2 py-2 py-sm-3">
                            <p class="darkgrey-text mb-0">Memoria: <span id="Memory"></span></p>
                        </div>                            
                      </div>
                      <div class="col-8 col-sm-5 col-md-4 mx-auto py-2 mt-2 mb-2 mb-sm-4">
                        <div class="card transparent text-center z-depth-2 py-2 py-sm-3">
                            <p class="darkgrey-text mb-0">A pagar: <span id="Payment"></span></p>
                        </div>                            
                      </div>
                    </div>
    ...
    <script src="https://cdn.admin.siempregana.net/js/finance_affiliates_own_balance-min.js"></script>
