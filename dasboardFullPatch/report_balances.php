...
<head>
  ...
  <title>SiempreGana</title>
    ...
    <link rel="stylesheet" type='text/css' href="https://cdn.admin.siempregana.net/css/report_balances-min.css">
...
<nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
              ...
              <div class="card">
                <div class="card-body p-1 py-4 px-sm-4">
                  <div class="row">
                    ...
                    <div class="col-8 offset-2 col-sm-3 offset-sm-2 col-md-2 offset-md-1 col-lg-4 offset-lg-2 col-xl-2 offset-xl-1 px-2 pl-sm-0 pl-xl-3">
                      <select class="mdb-select colorful-select dropdown-primary md-form" id="search_type">
                        <option value="player">Jugadores</option>
                        <option value="affiliate">Agentes</option>
                      </select>
                    </div>
                    <div class="col-8 offset-2 col-sm-4 offset-sm-1 col-md-3 offset-md-0 col-lg-4 col-xl-3 offset-xl-0 pb-xl-4">
                    ...
                    <div class="col-8 offset-2 col-sm-4 offset-sm-3 col-md-3 offset-md-0 col-lg-5 offset-lg-2 col-xl-3 offset-xl-0 pl-2 pl-sm-0 pl-md-3 pt-3 pt-sm-0 pt-md-3 pt-lg-0 pt-xl-3 px-lg-2 px-xl-3 text-xl-left">
                      <div class="form-check form-check-inline">
                        <input type="checkbox" class="form-check-input" id="direct_children">
                        <label class="form-check-label pl-4" for="direct_children" data-toggle="popover" data-placement="top"  data-content="Solo mostrar cargas y retiros realizados a usuarios directos">Directos <i class="fas fa-info mx-2"></i></label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input type="checkbox" class="form-check-input" id="by_parent">
                        <label class="form-check-label change-group pl-4" for="by_parent" data-toggle="popover" data-placement="top" data-content="Solo mostrar cargas y retiros realizadas por un Superior">Superior <i class="fas fa-info mx-2"></i></label>
                      </div>
                      <div class="d-none form-check form-check-inline">
                        <input type="checkbox" class="form-check-input" id="from_parent">
                        <label class="form-check-label change-group pl-4" for="from_parent" data-toggle="popover" data-placement="top" data-content="Mostrar cargas y retiros realizados a mi panel">Recibidas <i class="fas fa-info mx-2"></i></label>
                      </div>
                    </div>
                    <div class="col-10 offset-1 col-sm-5 offset-sm-0 col-md-3 col-lg-4 col-xl-2 pt-3 pt-sm-1 pt-md-4 pt-lg-1 pt-xl-3 pb-3 px-xl-0 text-center text-sm-left text-lg-left">
  ...
  <script src="https://cdn.admin.siempregana.net/js/report_balances-min.js"></script>
