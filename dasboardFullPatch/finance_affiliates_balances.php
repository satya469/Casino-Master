...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" type='text/css' href="https://cdn.admin.siempregana.net/css/finance_affiliates_balances-min.css">
...
<nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
                  ...
                  <div class="card-body p-1 px-sm-4">
                    <div class="row">
                      <div class="col-8 offset-2 col-sm-4 offset-sm-2 offset-xl-0 px-2 pl-sm-0 pl-xl-5">
                        <select class="mdb-select colorful-select dropdown-primary md-form" searchable="Buscar" id="affiliate_id">
                          <option value="" selected>Agentes</option>
                          
                          <option value="38840">Alejandromaster</option>
                          
                          <option value="26275">Elibet1</option>
                          
                          <option value="26271">Pedroadmin</option>
    ...
    <script src="https://cdn.admin.siempregana.net/js/finance_affiliates_balances-min.js"></script>
