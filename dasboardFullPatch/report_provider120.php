...
<head>
  ...
  <title>SiempreGana</title>
    ...
    <link rel="stylesheet" type='text/css' href="https://cdn.admin.siempregana.net/css/report_provider120-min.css">
...
<nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
              ...
              <div class="card">
                <div class="card-body p-1 py-4 px-sm-4"">
                  <div class="row">
                    ...
                    <div class="col-8 offset-2 col-sm-3 offset-sm-0 col-lg-4 col-xl-3 offset-xl-1">
  ...
  <script src="https://cdn.admin.siempregana.net/js/report_provider120-min.js"></script>
