...
<head>
  ...
  <title>SiempreGana</title>
    ...
    <link rel="stylesheet" type='text/css' href="https://cdn.admin.siempregana.net/css/report_global_player-min.css">
...
<nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
              ...
              <div class="card">
                <div class="card-body p-1 px-sm-2">
                  <div class="row col-12 col-xl-11 mx-auto px-0 px-md-2 px-lg-0 mb-2">
                    ...
                    <div class="col-6 col-sm-3 mx-auto pt-1 pb-3 px-sm-0 px-md-2 px-lg-0 px-xl-2 text-center order-sm-2">
                    ...
                    <div class="col-6 col-sm-3 pt-1 pb-3 text-center d-none">
                      <button class="btn btn-sm btn-cyan waves-effect waves-light disabled" id="change_view"><i class="fas fa-plus mr-2"></i> detalles</button>
                    </div>
                  </div>
                ...
                <div class="card-footer d-none">
                  <div class="font-size-custom red-text">
  ...
  <script src="https://cdn.admin.siempregana.net/js/report_global_player-min.js"></script>
