...
<html lang="es">
    ...
    <meta name="theme-color" content="#ffffff">
        ...
        <link rel="stylesheet" type='text/css' href="https://cdn.admin.siempregana.net/css/finance_affiliates_operation-min.css">
...
<nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
    ...
    <div class="modal fade" id="ModalLoginHistory" tabindex="-1" role="dialog" aria-labelledby="LoginHistory" aria-modal="true">
        ...
        <script src="https://cdn.admin.siempregana.net/js/finance_affiliates_operation-min.js"></script>
