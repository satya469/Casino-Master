...
<head>
  ...
  <title>SiempreGana</title>
    ...
    <link rel="stylesheet" type='text/css' href="https://cdn.admin.siempregana.net/css/report_global-min.css">
...
<nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
            ...
            <div class="col-12 col-lg-9 thin" id="main_container">
              <div class="card">
                <div class="card-body p-1 px-sm-2">
                  <div class="row col-12 col-xl-11 mx-auto px-0 px-md-2 px-lg-0 mb-2">
                    <div class="col-9 col-sm-5 col-xl-4 mx-auto order-sm-1">
                      <select class="mdb-select colorful-select dropdown-primary md-form my-2 font-size-custom2" id="pre_date">
                        <option value="today" selected>Hoy</option>
                        <option value="yesterday">Ayer</option>
                        <option value="thisWeek">Semana actual</option>
                        <option value="lastWeek">Semena previa</option>
                        <option value="thisMonth">Mes actual</option>
                        <option value="lastMonth">Mes previo</option>
                    ...
                    <div class="col-6 col-sm-3 mx-auto text-center order-sm-3">
                      <button class="btn btn-sm btn-cyan waves-effect waves-light disabled" id="change_view">detalles</button>
                    </div>
                  </div>
                  <table id="history" class="table table-hover w-100" cellspacing="0">
                    <thead>
                      <tr>
                        <th scope="col"></th>
                        <th scope="col"></th>
                ...
                <div class="card-footer d-none">
                  <div class="card-footer-missing font-size-custom red-text d-none">
                    * No se puede procesar el reporte. Por favor configurar las comisiones de los Proveedores:
                    <span class="font-italic"></span>
                  </div>
                  <div class="card-footer-fix-time font-size-custom blue-text d-none">
  ...
  <script src="https://cdn.admin.siempregana.net/js/report_global-min.js"></script>
