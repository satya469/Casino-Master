...
<head>
  ...
  <title>SiempreGana</title>
    ...
    <link rel="stylesheet" type='text/css' href="https://cdn.admin.siempregana.net/css/report_player_history-min.css">
...
<nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
        ...
        <div class="col-md-12 p-0">
          <div class="row mt-4 mb-3">
            <div class="col-6 col-lg-9 pt-2 pl-4">
              <h5 class="white-text font-weight-bold">Historial de Saldo</h5>
            </div>
              ...
              <div class="card">
                <div class="card-body p-1 py-4 px-sm-4"">
                  <div class="row">
                    ...
                    <div class="col-8 offset-2 col-sm-4 offset-sm-2 col-lg-4 col-xl-3 offset-xl-2 pb-xl-4 pt-xl-3">
                    ...
                    <div class="col-5 offset-5 col-sm-3 offset-sm-1 col-lg-3 col-xl-3 offset-xl-1 pt-2 pt-xl-3 pb-4 pb-sm-3 text-center text-xl-right">
  ...
  <script src="https://cdn.admin.siempregana.net/js/report_player_history-min.js"></script>
