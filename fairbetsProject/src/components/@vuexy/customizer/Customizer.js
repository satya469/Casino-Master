...
import { themeinforsave } from "../../../redux/actions/auth/loginActions"
...
class Customizer extends React.Component {
  ...
  themesave = () => {
    const inputdata = this.props.customizer
...
activeMode: this.props.activeMode,
  ...
  render() {
    const { activeNavbar, footerType, menuTheme, activeMode, collapsedSidebar } = this.state
          ...
          return (
            <div className={classnames("customizer d-none d-md-block", { open: this.props.customizerState === true })} >
              ...
              <PerfectScrollbar options={{ wheelPropagation: false }} className="customizer-content p-2" >
                ...
                <div className="theme-mode">
                  ...
                  <div className="d-inline-block">
                    <Radio
                      label="golden"
                      color="warning"
                      checked={activeMode === "golden-dark"}
                      name="themeLayout"
                      onChange={() => this.props.changeMode("golden-dark")}
                    />
                  </div>
                ...
                {
                  user ? <div>
                      <Button.Ripple className="igamez-button" color="success" onClick={() => { this.themesave() }}>Save </Button.Ripple>
                    </div> : null
                }
