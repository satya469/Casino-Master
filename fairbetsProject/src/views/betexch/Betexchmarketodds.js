...
import { getmarkets, getSportlist, setactiveSport, setmatchelist, setSportslist, setodds, setallmatchelist, setmatches, destryoddsSession, setbetsdata, dateConvert, getopenbets, setopenbets, setBetslip, setprofitlossObj, getPNL, getMarketsById } from "../../redux/actions/betexchg"
...
const Odds = () => {
    ...
    const { activeSport, matchelist, Inplay, activeodds,openbets, profitlossObj, lastactiveodds, activematche } = useSelector(state => state.betexch)
                                                                ...
                                                                <div className="w-50">
                                                                    <div className="fancyitembody">
                                                                        ...
                                                                        <Row className="w-40 m-0 d-flex justify-content-end">
                                                                            <div className=" position-relative d-flex">
                                                                                {
                                                                                    odditem.GameStatus === "SUSPENDED" || item.oddsstatus === "SUSPENDED" ?
                                                                                        <div className="suspend">
                                                                                            <span >
                                                                                                SUSPENDED
                                                                                            </span>
                                                            ...
                                                            <Fragment key={i + o}>
                                                                <div className="oddsitembody">
                                                                    ...
                                                                    <Row className="w-70 m-0 d-flex justify-content-end position-relative">
                                                                        {
                                                                            odditem.status === "SUSPENDED" || item.oddsstatus === "SUSPENDED" ?
                                                                                <div className="suspend">
                                                                                    <span >
                                                                                        SUSPENDED
                                                                                    </span>
                                                        ...
                                                        item.odds.map((odditem, o) => (
                                                            <Fragment key={i + o}>
                                                                <div className="oddsitembody">
                                                                    ...
                                                                    <Row className="w-70 m-0 d-flex justify-content-end position-relative">
                                                                        {
                                                                            item.oddsstatus === "SUSPENDED" || odditem.status === "SUSPENDED" ?
                                                                                <div className="suspend">
                                                                                    <span >
                                                                                        SUSPENDED
                                                                                    </span>
    ...
    const loadmatch = async () => {
        ...
        if (request && item) {
            let markets = await getMarketsById({ item })
            if (markets.status) {
                let matchid = markets.data.event.id
                openbetsload({ matchid }, markets.data)
                scoreLoad(matchid)
                dispatch(setodds(markets.data))
            } else {
                // history.push("/betexchmymarkets")
            }
        } else {
            // history.push("/betexchmymarkets")
        }
