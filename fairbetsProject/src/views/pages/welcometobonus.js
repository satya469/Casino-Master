...
export class welcometobonus extends Component {
    ...
    componentDidMount() {
        ...
        Letter.prototype.step = function() {
            ...
            if (this.phase === 'firework') {
                ...
                if (this.circleCreating) {
                    ...
                    ++this.tick2
                    const proportion1 = this.tick2 / this.circleFadeTime,
                ...
                if (this.spawning) {
                    ...
                    const proportion2 = this.tick / this.inflateTime,
                        x2 = this.cx = this.x,
        ...
        function anim() {
            ...
            if (done) for (let l1 = 0; l1 < letters.length; ++l1) letters[l1].reset()
        }
