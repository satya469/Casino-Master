...
class Casino extends React.Component {
  ...
  componentDidMount() {
    this.props.data_load(providerconfig["CRICKET"], "14", "CRECKETSLIDERS")
  ...
  typesActive = value => {
    this.props.gametypechange(value, providerconfig.CRICKET)
  }

  provider_change = value => {
    this.props.providerchange(value, providerconfig.CRICKET)
  }
...
const get_game = (state) => {
  ...
  return {
    casinoSlider_images: state.sliders.cricket_images,
