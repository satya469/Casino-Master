...
<head>
    ...
    <title>SiempreGana | Casino Vivo</title>
    ...
    <link rel="stylesheet" type='text/css' href="https://cdn.siempregana.net/css/livecasino-min.css">
    
    <link rel="stylesheet" type='text/css' href="https://cdn.siempregana.net/mkt/css/10/13/livecasino.css">
...
<div class="card z-depth-2" id="BrowserAdvice">
    ...
    <main id="main">
        <div class="col-12 justify-content-center" id="current_container">
            <iframe id="game_object" scrolling="no" frameborder="0" allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen"></iframe>
        </div>
        <div class="col-12 px-0 text-center mb-4" id="banner_container"></div>
        <div class="mt-0 mt-sm-2 mt-lg-3" id="games_container">
            
            <div class="col-10 offset-1 col-sm-3 offset-sm-0 mt-4 mt-sm-0 mx-auto view overlay zoom game-item" data-system="500" data-pagecode="101">
                <img src="https://cdn.siempregana.net/images/pragmatic_live.png" class="img-fluid z-depth-1">
                <div class="mask flex-center waves-effect waves-light">
                    <p class="white-text"><i class="far fa-play-circle"></i></p>
                </div>
            </div>
            
            <div class="col-10 offset-1 col-sm-3 offset-sm-0 mt-4 mt-sm-0 mx-auto view overlay zoom game-item" data-system="400" data-pagecode="lobby">
                <img src="https://cdn.siempregana.net/images/vivogaming.png" class="img-fluid z-depth-1">
                <div class="mask flex-center waves-effect waves-light">
                    <p class="white-text"><i class="far fa-play-circle"></i></p>
                </div>
            </div>
            
            <div class="col-10 offset-1 col-sm-3 offset-sm-0 mt-4 mt-sm-0 mx-auto view overlay zoom game-item" data-system="499" data-pagecode="lobby">
                <img src="https://cdn.siempregana.net/images/freshdeck.jpg" class="img-fluid z-depth-1">
                <div class="mask flex-center waves-effect waves-light">
                    <p class="white-text"><i class="far fa-play-circle"></i></p>
                </div>
            </div>
            
            <div class="col-10 offset-1 col-sm-3 offset-sm-0 mt-4 mt-sm-0 mx-auto view overlay zoom game-item" data-system="602" data-pagecode="ez-roulette">
                <img src="https://cdn.siempregana.net/images/ezugi_live.jpg" class="img-fluid z-depth-1">
                <div class="mask flex-center waves-effect waves-light">
                    <p class="white-text"><i class="far fa-play-circle"></i></p>
                </div>
            </div>
    ...
    <script src="https://cdn.siempregana.net/js/livecasino-min.js"></script>
