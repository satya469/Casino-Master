...
<head>
    ...
    <title>SiempreGana | Deportes</title>
    ...
    <link rel="stylesheet" type='text/css' href="https://cdn.siempregana.net/css/sports-min.css">
    
    <link rel="stylesheet" type='text/css' href="https://cdn.siempregana.net/mkt/css/10/13/sports.css">
...
<div class="card z-depth-2" id="BrowserAdvice">
    ...
    <script src="https://sport.siempregana.net/js/Partner/IntegrationLoader.min.js" ></script>
    ...
    <script src="https://cdn.siempregana.net/js/sports-min.js"></script>
